...
-- ╚═════════════════════════════════════════╝
CREATE OR ALTER PROCEDURE Reportes.AcumuladoMensualPorActividad
AS
BEGIN
    SET NOCOUNT ON;
...
CREATE OR ALTER PROCEDURE Reportes.InasistenciasPorCategoriaYActividad
AS
BEGIN
    SET NOCOUNT ON;
...
-- ╚══════════════════════════════════════════════╝
CREATE OR ALTER PROCEDURE Reportes.SociosConInasistenciasAActividades
AS
BEGIN
    SET NOCOUNT ON;
