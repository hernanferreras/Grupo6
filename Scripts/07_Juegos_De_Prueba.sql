...
SELECT 
    ID_Empleado,
    CONVERT(VARCHAR(20), DECRYPTBYPASSPHRASE('ClaveGrupo06', DNI)) AS DNI,
    FechaNacimiento,
    FechaIngreso,
    FechaBaja,
    CONVERT(NVARCHAR(50), DECRYPTBYPASSPHRASE('ClaveGrupo06', Nombre)) AS Nombre,
    CONVERT(NVARCHAR(100), DECRYPTBYPASSPHRASE('ClaveGrupo06', Apellido)) AS Apellido,
    CONVERT(NVARCHAR(100), DECRYPTBYPASSPHRASE('ClaveGrupo06', Email)) AS Email,
    CONVERT(VARCHAR(20), DECRYPTBYPASSPHRASE('ClaveGrupo06', TelefonoContacto)) AS TelefonoContacto,
    ID_Rol,
    ID_Usuario
