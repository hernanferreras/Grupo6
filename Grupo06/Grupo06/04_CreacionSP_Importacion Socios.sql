...
-----------------------------------------------------------------
    ...
    CREATE TABLE #ImportacionSocios (
        ...
        TelefonoContacto NVARCHAR(100),
        TelefonoEmergencia NVARCHAR(100),
        ObraSocial VARCHAR(100),
        NroSocioObraSocial VARCHAR(100),
        TelefonoObraSocial NVARCHAR(100)
    );
   ...
   -- Formateo TelefonoContacto
    CASE 
        WHEN LEN(LTRIM(RTRIM(TelefonoContacto))) = 10 AND TelefonoContacto NOT LIKE '%[^0-9]%' THEN
            SUBSTRING(TelefonoContacto,1,2) + '-' + SUBSTRING(TelefonoContacto,3,4) + '-' + SUBSTRING(TelefonoContacto,7,4)
        WHEN LEN(TelefonoContacto) = 8 AND TelefonoContacto NOT LIKE '%[^0-9]%' THEN
            SUBSTRING(TelefonoContacto,1,4) + '-' + SUBSTRING(TelefonoContacto,5,4)
        ELSE 
            TelefonoContacto
    END,

    -- Formateo TelefonoEmergencia
    CASE 
        WHEN LEN(LTRIM(RTRIM(TelefonoEmergencia))) = 10 AND TelefonoEmergencia NOT LIKE '%[^0-9]%' THEN
            SUBSTRING(TelefonoEmergencia,1,2) + '-' + SUBSTRING(TelefonoEmergencia,3,4) + '-' + SUBSTRING(TelefonoEmergencia,7,4)
        WHEN LEN(TelefonoEmergencia) = 8 AND TelefonoEmergencia NOT LIKE '%[^0-9]%' THEN
            SUBSTRING(TelefonoEmergencia,1,4) + '-' + SUBSTRING(TelefonoEmergencia,5,4)
        ELSE 
            TelefonoEmergencia
    END,
        LTRIM(RTRIM(ObraSocial)),                                     -- Obra Social
        LTRIM(RTRIM(NroSocioObraSocial)),                             -- Numero Obra Social
    -- Formateo TelefonoObraSocial
    CASE 
        WHEN LEN(TelefonoObraSocial) = 10 AND TelefonoObraSocial NOT LIKE '%[^0-9]%' THEN
            SUBSTRING(TelefonoObraSocial,1,2) + '-' + SUBSTRING(TelefonoObraSocial,3,4) + '-' + SUBSTRING(TelefonoObraSocial,7,4)
        WHEN LEN(TelefonoObraSocial) = 8 AND TelefonoObraSocial NOT LIKE '%[^0-9]%' THEN
            SUBSTRING(TelefonoObraSocial,1,4) + '-' + SUBSTRING(TelefonoObraSocial,5,4)
        ELSE 
            TelefonoObraSocial
    END                             -- Telefono Obra Social
    FROM #ImportacionSocios;
